<template>
  <div>
    <section v-if="!showLoading" class="shop_container">
      ...
      >
        <div class="header_cover_img_con">
          <img
            :src="baseImgUrl + shopDetailData.image_path"
        ...
        <section class="description_header">
          <router-link to="/shop/shopDetail" class="description_top">
            <section class="description_left">
              <img :src="baseImgUrl + shopDetailData.image_path" />
            </section>
                  ...
                  >
                    ...
                    >
                      <section class="menu_food_img">
                        <img :src="baseImgUrl + foods.image_path" />
                      </section>
          ...
          <section class="buy_cart_container">
            <section @click="toggleCartList" class="cart_icon_num">
              ...
              >
                ...
                <Icon class="cart_icon" type="ios-cart" color="#fff" />
              </div>
              <div class="cart_num">
                <div>¥ {{ totalPrice }}</div>
            ...
            >
              <header>
                ...
                <div @click="clearCart">
                  ...
                  <Icon type="ios-trash" color="#ccc" style="font-size:.9rem" />
    ...
    <transition name="fade">
      <p class="show_delete_tip" v-show="showDeleteTip">
        多规格商品只能去购物车删除哦
      </p>
    </transition>
    <transition
  ...
  methods: {
    ...
    async initData() {
      ...
      [
        ...
        shopDetails(this.shopId, this.latitude, this.longitude),
        foodMenu(this.shopId),
        getRatingList(this.shopId, this.ratingOffset),
        ratingScores(this.shopId),
        ratingTags(this.shopId),
      ]);
