          ...
          <section v-show="sortBy == 'sort'" class="sort_detail_type">
            <ul class="sort_list_container" @click="sortList($event)">
              <li class="sort_list_li">
                ...
                <Icon type="md-resize" color='#2a9bd3' />
                <p data="0" :class="{ sort_select: sortByType == 0 }">
                  ...
                  <Icon type='md-checkmark' color='#3190E8' v-show='sortByType == 0' />
                </p>
              </li>
              <li class="sort_list_li">
                <!-- <svg>
                ...
                <Icon type="ios-pin-outline" color='#3190E8' />
                <p data="5" :class="{ sort_select: sortByType == 5 }">
                  ...
                  <Icon type='md-checkmark' color='#3190E8' v-show='sortByType == 5' />
                </p>
              </li>
              <li class="sort_list_li">
                <!-- <svg>
                ...
                <Icon type="ios-flame-outline" color='#f07373' />
                <p data="6" :class="{ sort_select: sortByType == 6 }">
                  ...
                  <Icon type='md-checkmark' color='#3190E8' v-show='sortByType == 6' />
                </p>
              </li>
              <li class="sort_list_li">
                <!-- <svg>
                ...
                <Icon type="logo-usd" color='#ECC853' />
                <p data="1" :class="{ sort_select: sortByType == 1 }">
                  ...
                  <Icon type='md-checkmark' color='#3190E8' v-show='sortByType == 1' />
                </p>
              </li>
              <li class="sort_list_li">
                <!-- <svg>
                ...
                <Icon type="md-speedometer" color='#37c7b7' />
                <p data="2" :class="{ sort_select: sortByType == 2 }">
                  ...
                  <Icon type='md-checkmark' color='#3190E8' v-show='sortByType == 2' />
              ...
              <li class="sort_list_li">
                ...
                <Icon type="ios-star-outline" color='#eba53b' />
                <p data="3" :class="{ sort_select: sortByType == 3 }">
                  ...
                  <Icon type='md-checkmark' color='#3190E8' v-show='sortByType == 3' />
                </p>
              </li>
            </ul>
          </section>
