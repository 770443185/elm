    ...
    <section class="profile-info">
      <section class="headportrait">
        ...
        <div class="headportrait-div">
          ...
          <span class="headportrait-div-top" v-else>
            ...
            <img src="../../../assets/images/akari.jpg" style="width:100%; height:100%; border-radius: 50%;" alt="">
          </span>
      ...
      <section class="info-router" @click="changePhone">
        <section class="headportrait headportraitwo headportraithree">
          <h2>
            <img
              src="../../../assets/images/bindphone.png"
  ...
  methods: {
    ...
    async uploadAvatar() {
      ...
      if (this.userInfo) {
        ...
        try {
          let response=await upAvatar('include',data,this.userInfo.user_id);
