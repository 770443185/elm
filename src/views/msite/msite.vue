<template>
  <div>
    ...
    <nav class="msite_nav">
      <div class="swiper-container" v-if="foodTypes.length" ref="swiperContainer" >
    ...
    <div class="shop_list_container" >
      <header class="shop_header" style="display: flex; align-items: center;">
        <!-- <svg class="shop_icon">
          <use
            xmlns:xlink="http://www.w3.org/1999/xlink"
            xlink:href="#shop"
          ></use> -->
          <Icon class="shop_icon" style="font-size: .9rem; margin-right: .3rem;"  color='#ccc' type="ios-restaurant" />
        </svg>
