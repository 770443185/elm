    ...
    <section v-if="!showLoading">
      ...
      >
        <div class="address_empty_left">
          ...
          <Icon class="location_icon" type="ios-pin-outline" />
        ...
        <Icon class="address_empty_right" type="ios-arrow-forward" />
      </router-link>
      ...
      <section class="food_list">
        <header v-if="checkoutData.cart.restaurant_info">
          <img
            :src="baseImgUrl + checkoutData.cart.restaurant_info.image_path"
          />
...
export default {
  ...
  methods: {
    ...
    // 
    tipClick(){
        if(!this.checkoutData||this.checkoutData.status==0){
            this.$router.go(-1)
        }else{
